package seu.util.rongyun.io.rong;
...
import seu.util.rongyun.io.rong.messages.*;
...
public class Example {
	//Example.class.getClassLoader().getResource("jsonsource").getPath()
	private static final String JSONFILE = "D:/Users/dell/Workspaces/MyEclipse 10/ssmdemo/ssmdemo/src/main/java/rongyun/jsonsource/";
	public static String appkey="cpj2xarlc1t0n";
	public static String secret="dRX8xfk05g";
	...
	public Example() throws Exception {
		...
		String[] messagePublishSystemToUserId = {"38","40"};
		TxtMessage messagePublishSystemTxtMessage = new TxtMessage("hello", "helloExtra");
		CodeSuccessResult messagePublishSystemResult = rongCloud.message.PublishSystem("1", messagePublishSystemToUserId, messagePublishSystemTxtMessage, "thisisapush", "{\"pushData\":\"hello\"}", 0, 0);
